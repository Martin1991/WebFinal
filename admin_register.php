...
$num = mysqli_num_rows($order_query);
        $admin_query = mysqli_query($con,"SELECT user_id, email, password, first_name, last_name, phone, occupation, sex, dob FROM guider, register WHERE user_id=guider_id");
        ...
        <body>
			<header>
                ...
                <div class = 'main-contatiner'>
                        ...
                        <div>
							<p class='admin_head'>Register Management</p>
						</div>
                        <table class='table table-striped'>
                         ...
                         while ($row = mysqli_fetch_array($admin_query)) {
                                ...
                                <td>".$row['dob']."</td>
                                <td colspan='2'>
									<form action='admin_register_update.php' method='POST'>
											<input type='hidden' class='userId' name='userId' value='".$row['user_id']."'>
											<button type='submit' class='admin btn btn-success' name='edit'>Edit</button>
											<button type='submit' class='admin btn btn-success' name='delete'>Delete</button>
									</form>
                                </td>
                         </tr>
                         ";
