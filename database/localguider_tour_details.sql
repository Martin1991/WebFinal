...
--
-- Host: localhost    Database: localguider
-- ------------------------------------------------------
...
CREATE TABLE `tour_details` (
  ...
  `tour_line` varchar(200) NOT NULL,
  `status` varchar(45) NOT NULL,
  PRIMARY KEY (`ttour_id`),
  CONSTRAINT `ttour_id` FOREIGN KEY (`ttour_id`) REFERENCES `tour` (`tour_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2015-11-12 16:17:08
