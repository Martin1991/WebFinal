...
$sql="SELECT tour.tour_name, tour.tour_description, tour.location, tour.tuser_id, tour.cover_url, tour.tour_id, tour_order.pay_date, tour_details.price, guider.profile_image, tour_details.ending_time-tour_details.starting_time as duration, register.user_name 
      FROM tour_order
	  ...
	  WHERE tour_order.customer_id='$userId' AND tour_order.checkout='1'";
...
<html xmlns='http://www.w3.org/1999/xhtml'>
	<head>
	    ...
	    <link href='css/userResult.css' type='text/css' rel='stylesheet'/>
	...
	<body class='main-container'>
		...
		<div class='result_contain container'>
			<p class='head_title'>My History</p>
					...
					<div class='item_content col-md-9'>
						...
						<div class='content_down '>
							...
							<div class='button_right'>
								...
								<div class='payDate_div'>
									<div>
										<p class='checkout_title'>Checkout Date</p>
									</div>
									<div>
										<p class='checkout_date'>".$row['pay_date']."</p>
									</div>
								</div>
							</div>
						</div>
